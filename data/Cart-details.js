fetch('Cosmetic.json')
  ...
  function cartData(data) {   
      ...
      document.getElementById("bag").innerHTML+=" ("+array.length+") ";
      ...
      for(var j=0;j<array.length;j++){
        ...
        card.classList.add("container","p-3");
        let content=`
        ...
        <br>
            ...
            <div class="col-sm-7">
                ...
                <div class="d-flex flex-column">
                    ...
                    <button type="button" class="btn-danger" style="width:50%" onclick=remove(${data[i].id})>Delete</button>
                </div>
                <br>  
            </div>
        </div>`
